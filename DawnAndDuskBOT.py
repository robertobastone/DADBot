...
today = datetime.now().astimezone(cet).date() # format like 2021-03-27
#date = 'date=today&' unclear if todays is referred to the api local time
date = 'date='+str(today)+"&"
...
def getSunriseSunsetTimeString(datetime_sun,event_sun):
    try:
        ...
        if event_sun == 'sunrise':
            ...
            action_item = 0
        timezone_item = datetime_item.tzname() # should return CET or CEST
